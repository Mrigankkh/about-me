...
function Travel() {
  ...
  return(
    <Container className='fluid travel-section'>
        ...
        <p style={{ color: "white" }}>
          I am a travel enthusiast and here are the countries I have visited so far. Click on the countries to look at pictures!.
        </p>
        <Row className='travel-map' style={{ justifyContent: "center", paddingBottom: "10px", position:'relative'  }}>
        <div  id="chartdiv" ref={chartDivRef} style={{ width: "100%", height: "500px",
         }}></div>;
    ...
    {countries.map((country, index) => (
      ...
      <Row id={getLowerCaseId(country.id)}  >
